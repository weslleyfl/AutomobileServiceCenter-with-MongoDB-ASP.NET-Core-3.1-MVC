...
namespace ASC.Web.Data.Cache
{
    ...
    public class MasterDataCacheOperations : IMasterDataCacheOperations
    {
        ...
        public async Task GetOrSetValueMasterDataCacheAsync()
        {
            MasterDataCache masterDataCache = await GetMasterDataCache();

            await _cache.GetOrSetValueAsync<MasterDataCache>(
                    MasterDataCacheName,
                    () => Task.FromResult(masterDataCache),
                    DistributedCacheExtensions.DefaultDistributedCacheEntryOptions);
        }
        ...
        private async Task<MasterDataCache> GetMasterDataCache()
        {
